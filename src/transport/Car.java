...
public class Car {
    ...
    public Car(String brand, String model, double engineVolume, String color, int year,
               String country, String gearBbox, String bodywork, String registrationNumber,
    ...
    public void setRegistrationNumber(String registrationNumber) {
        ...
        if (this.registrationNumber == null || this.registrationNumber.isEmpty() || this.registrationNumber.isBlank()) {
    ...
    public String toString() {
        return this.brand + " " + this.model + ", " + this.year + " год выпуска, страна сборки - " + this.country +
                ", цвет кузова - " + this.color + ", объем двигателя - " + this.engineVolume + " л, коробка передач - "
                + this.gearBbox + ", тип кузова - " + this.bodywork + ", количество мест - " + this.seatNumber +
                ", регистрационный номер - " + this.registrationNumber + ", зимняя ли резина - " + this.areTyresSnow
                + ", " + this.key + ". Данные о страховке: " + this.insurance;
    }
}
